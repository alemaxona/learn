...
// Прочитать разделы 2.7 - 2.10
// Упражнения 2.6 – 2.8
// (Опционально) Доказать, что если a ^ b ^ c ^ d = e, то a ^ b ^ e ^ d = c.

// Б. Керниган, Д. Ритчи. Язык программирования Си:
// Прочитать разделы 2.11 - 3.4
// Написать программу, выводящую в консоль результат вычисления квадратного уравнения в области действительных и комплексных чисел. Параметры a, b и с – действительные числа (тип double) запросить из консоли с помощью функции getchar(). Формат результата:
// Уравнение x*x + 1 = 0 имеет 1 корень x1 = 1.000000*i
